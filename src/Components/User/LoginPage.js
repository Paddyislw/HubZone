    ...
    return (
        <div className=''>
            <div className='banner h-44  relative bg-gradient-to-tl from-gray-700 to-gray-600'>
                ...
                <p className='text-white text-5xl font-mono font-bold px-36 py-14'>Login</p>
            </div>
            <div className='my-32'>
                <div className='flex justify-center items-center flex-col bg-red-100 w-[300px] mx-auto pt-10 rounded-md'>
              ...
              <Link to='/signUp'>  <p className='text-center my-2 text-blue-700 hover:text-blue-900'>Don't have an account? Create an account</p></Link>
            </div>
        </div>
    )
}
